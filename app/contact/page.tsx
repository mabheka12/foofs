      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@roofleakrepaird.com" className="text-gray-600 hover:text-blue-600">
          ...
          <div className="bg-blue-50 rounded-xl p-6">
            <h3 className="font-semibold text-gray-900 mb-2">Emergency Roof Repair?</h3>
            <p className="text-gray-600 text-sm mb-4">
              Need immediate assistance? Call our emergency hotline for 24/7 support.
            </p>
            <a
              href="tel:+18005551234"
              className="block text-center bg-red-600 text-white px-4 py-3 rounded-lg hover:bg-red-700 transition font-medium"
            >
